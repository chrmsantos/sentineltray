...
- A status report email is sent every 7 scan iterations with detailed runtime fields.
...
- Tray status shows the last status report send time.
...
- Status exports include last_report_send for report cadence tracking.
